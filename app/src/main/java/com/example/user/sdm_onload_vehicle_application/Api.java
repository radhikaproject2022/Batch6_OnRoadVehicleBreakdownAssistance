...
public interface Api
{
    ...
    @GET("https://jolty-act.000webhostapp.com/onroad/user_api/fetch_profile.php")
    Call<List<User>> getProductByCode(@Query("f1") String string_mno);

    @GET("https://jolty-act.000webhostapp.com/onroad/fuel_api/fetch_Fuel_profile.php")
    Call<List<Fuel>> getFuel_profile(@Query("f1") String string_mno);



    @GET("https://jolty-act.000webhostapp.com/onroad/garage_api/fetch_Garage_profile.php")
    Call<List<Garage_User>> getGarage_profile(@Query("f1") String string_mno);



    @GET("https://jolty-act.000webhostapp.com/onroad/user_api/fetch_pg_details.php")
    Call<List<Garage>> getLoundryDetails(@Query("f1") String string_shop_name);



    @GET("https://jolty-act.000webhostapp.com/onroad/user_api/fetch_pg_details_fuel.php")
    Call<List<FuelConstructor>> getLoundryDetailsFuel(@Query("f1") String string_shop_name);




    @GET("https://jolty-act.000webhostapp.com/onroad/garage_api/fetch_get_shop_id.php")
    Call<List<Garage_enquiry>> getGarageId();

    @GET("https://jolty-act.000webhostapp.com/onroad/fuel_api/fetch_get_shop_id.php")
    Call<List<Fuel_enquiry>> getFuelId();


    @GET("https://jolty-act.000webhostapp.com/onroad/garage_api/fetch_get_shop_enquiry_problem.php")
    Call<List<Garage_enquiry>> getGarageProblem(@Query("f1") String string_input);

    @GET("https://jolty-act.000webhostapp.com/onroad/fuel_api/fetch_get_shop_enquiry_problem.php")
    Call<List<Fuel_enquiry>> getFuelProblem(@Query("f1") String string_input);


    @GET("https://jolty-act.000webhostapp.com/onroad/garage_api/fetch_get_shop_enquiry_problem_area_name.php")
    Call<List<Garage_enquiry>> Garage_user_address(@Query("f1") String string_input,@Query("f2") String string_input1);



    @GET("https://jolty-act.000webhostapp.com/onroad/fuel_api/fetch_get_Fuel_enquiry_problem_area_name.php")
    Call<List<Fuel_enquiry>> Fuel_user_address(@Query("f1") String string_input,@Query("f2") String string_input1);




    @GET("https://jolty-act.000webhostapp.com/onroad/garage_api/fetch_get_shop_enquiry_problem_details.php")
    Call<List<Garage_enquiry>> getUserProblemDetails(@Query("f1") String string_shop_name,@Query("f2") String string_input);


    @GET("https://jolty-act.000webhostapp.com/onroad/fuel_api/fetch_get_shop_enquiry_problem_details.php")
    ...
    @GET("https://jolty-act.000webhostapp.com/onroad/user_api/fetch_area_name.php")
    Call<List<Garage>> getAreaName(@Query("f1") String string_input);


    @GET("https://jolty-act.000webhostapp.com/onroad/user_api/fetch_area_name_fuel.php")
    ...
    @GET("https://jolty-act.000webhostapp.com/onroad/user_api/fetch_city_name.php")
    Call<List<Garage>> getCityName();




    @GET("https://jolty-act.000webhostapp.com/onroad/user_api/fetch_city_name_fuel.php")
    Call<List<FuelConstructor>> getCityNameFuel();




    @GET("https://jolty-act.000webhostapp.com/onroad/user_api/garage_name.php")
    Call<List<Garage>> getShopName(@Query("f1") String string_input, @Query("f2") String string_input1);


    @GET("https://jolty-act.000webhostapp.com/onroad/user_api/garage_name_fuel.php")
    Call<List<FuelConstructor>> getShopNameFuel(@Query("f1") String string_input, @Query("f2") String string_input1);




    @POST("https://jolty-act.000webhostapp.com/onroad/garage_api/garage_register.php")
    ...
    @POST("https://jolty-act.000webhostapp.com/onroad/user_api/register.php")
    ...
    @POST("https://jolty-act.000webhostapp.com/onroad/user_api/updaterating.php")
...
//
    ...
    @POST("https://jolty-act.000webhostapp.com/onroad/user_api/update_profile.php")
...
//
//
    @POST("https://jolty-act.000webhostapp.com/onroad/user_api/user_enquiry.php")
    ...
    @POST("https://jolty-act.000webhostapp.com/onroad/user_api/user_enquiry_fuel.php")
    ...
    @POST("https://jolty-act.000webhostapp.com/onroad/garage_api/garage_add_shop.php")
    ...
    @POST("https://jolty-act.000webhostapp.com/onroad/fuel_api/Fuel_add_shop.php")
    ...
    @POST("https://jolty-act.000webhostapp.com/onroad/fuel_api/Fuel_register.php")
