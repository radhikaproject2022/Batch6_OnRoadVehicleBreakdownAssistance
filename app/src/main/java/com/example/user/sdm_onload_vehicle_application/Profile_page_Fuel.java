...
public class Profile_page_Fuel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText_name = (EditText) findViewById(R.id.create_account_usernameu_fuel);
        editText_mno = (EditText) findViewById(R.id.create_account_mnou_fuel);
        editText_email = (EditText) findViewById(R.id.create_account_addressu_fuel);
        editText_password = (EditText) findViewById(R.id.create_account_passwordu_fuel);
